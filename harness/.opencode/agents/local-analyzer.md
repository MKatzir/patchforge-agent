...
3. **Data Commitment:** Immediately save the raw output from Ghidra by executing `python3 harness/write_chapter.py <chapter_id> <path_to_raw_output>`. 
...
## Permitted Tools:
- `ghidra_decompile.ts`
- `python3 harness/write_chapter.py <chapter_id> <source_path>`
